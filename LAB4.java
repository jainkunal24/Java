...
class LAB4{
		...
		public static void documentation(){
			...
			System.out.println("_______________________________________");
			System.out.println("Lab Programe-04 | Lab Cycle-01 | 28-06-19");
			System.out.println("   Constructor & Function Overloading    ");
			System.out.println("_______________________________________"); 
...
class Cricketer{
	...
	private double ODImatchFee;
	private double TESTmatchFee;
	private double T20matchFee; 
	private double manOfMatchAwardCashPrize = 51000.00;	
	...
	public Cricketer(int ODImatches,int manOfMatchAward,int jerseynumber,String name){
		...
		this.ODImatchFee = 200000.00;
		this.TESTmatchFee = 400000.00;
		this.T20matchFee = 100000.00; 
